...
const Project = () => {
  return (
    <>
      <div className="flex gap-4 text-[15px] py-5 text-[#2b2b2b] dark:text-[#dbdbdb] px-4">
        <div className="flex-1 flex flex-col gap-1">
          <div className="flex items-center font-semibold gap-10 ">
            <MarkdownComponent>Project Firebase</MarkdownComponent>
          ...
          <div className="text-[#727272] text-[13px]">
            <MarkdownComponent>google.com</MarkdownComponent>
          </div>
          <div className="mt-2">
            <MarkdownComponent>
              This is a project I developed while working at Boughview
              innovations.
            </MarkdownComponent>
          </div>
        </div>
