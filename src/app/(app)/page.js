...
import KeyboardSvg from "@/components/custom/KeyboardSvg";

export default function Home() {
    return (
        <>
            {/* Keyboard SVG at top right */}
            <div className="absolute top-4 right-1 md:right-16 -z-10 overflow-hidden pointer-events-none">
                <KeyboardSvg className="hidden dark:block opacity-75 overflow-hidden" />
            </div>
            <main className="md:pb-20 relative">
                ...
                <div className="my-5 px-4 text-[15px] dark:text-neutral-300">
                    ...
                    <div className="mt-2 space-y-4">
                        <p>
                            My name is Nureni Jamiu Olawale. I am a Software
                            Developer who loves building things and helping
                            people. I have a background in Cybersecurity,
                            focusing on Web Application Security. In 2021, I
                            switched to Software Development and have been
                            learning and building secure web applications ever
                            since. I am currently pursuing a{" "}
                            <b>double degree</b> in{" "}
                        ...
                        <p>
                            That&apos;s me in 15 seconds. If that peaked your
                            interest and would like to know more about me, then
                            kindly{" "}
                ...
                <div className="mt-10 text-[15px]">
                    ...
                    <div className="flex items-center px-4 mt-3">
                        ...
                        <span className="flex-1 font-[300]">
                            Nextjs, TailwindCSS, JetBrains Mono
                        </span>
                    </div>
                    <Divider type="border-dashed" />
                    <div className="flex items-center px-4 mt-3">
                ...
                <div className="md:hidden mt-10 mb-5 grid space-y-4 p-4">
                    <Link
                        ...
                        target="_blank"
                    >
                        <span className="group-hover:no-underline mr-2">
                            {" "}
                            🔘
                        </span>
