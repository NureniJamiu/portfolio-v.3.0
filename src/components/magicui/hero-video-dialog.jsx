    ...
    <div className={cn("relative", className)}>
      ...
      >
        <img
          ...
          width={1920}
          height={1080}
          className="w-full rounded-lg border border-neutral-700 shadow-lg transition-all duration-200 ease-out group-hover:brightness-[0.8"
        />
        <div className="absolute inset-0 flex scale-[0.9] items-center justify-center transition-all duration-200 ease-out group-hover:scale-100">
          <div className="flex size-14 md:size-28 items-center justify-center rounded-full bg-primary/10 backdrop-blur-md">
            <div
        ...
        {isVideoOpen && (
          ...
          >
            ...
            >
              ...
              <div className="relative isolate z-[1] size-full overflow-hidden rounded-2xl border-2 border-neutral-800">
                <iframe
                  src={videoSrc}
